...
<body>
    @section('content')
    <footer class="px-2 divide-y max-w-screen-2xl dark:bg-gray-800 dark:text-gray-100">
        <div class="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
            ...
            <div class="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                <div class="space-y-3">
                    <h3 class="uppercase tracki dark:text-gray-50">Product</h3>
                    <ul class="space-y-1">
                        <li>
                ...
                <div class="space-y-3">
                    <h3 class="uppercase tracki dark:text-gray-50">Company</h3>
                    <ul class="space-y-1">
                        <li>
