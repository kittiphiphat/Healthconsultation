    ...
    <header class="bg-white ">
        <nav class="flex justify-between items-center w-[90%]  mx-auto">
            ...
            <div class="flex items-center gap-6">
                ...
                <a href="/login"><button class="bg-gradient-to-t from-[#72b2e4] to-[#92e1e2] text-white px-5 py-2 rounded-full hover:bg-[#87acec] font-[Kanit]">เข้าสู่ระบบ</button></a>
                <a href="/register"><button class="bg-gradient-to-t from-[#72b2e4] to-[#92e1e2] text-white px-5 py-2 rounded-full hover:bg-[#87acec] font-[Kanit]">สมัครสมาชิก</button></a>
