...
<body class="font-[Kanit] bg-gradient-to-t from-[#72b2e4] to-[#92e1e2] h-screen">
    <header class="bg-white ">
        <nav class="flex justify-between items-center w-[90%]  mx-auto">
            <div>
                <a href="/home"><img class="w-16 cursor-pointer" src="https://cdn.discordapp.com/attachments/833096639332876339/1213512125436395602/423599767_1237264067233475_135039887890431936_n.png?ex=65f5be3c&is=65e3493c&hm=2bf51f79ae604d06f35256c39570d4a206523796f994b76ce04b95b1b8365b0b&" alt="..."></a>
            </div>
            <div
            ...
            <div class="flex items-center gap-6">
                ...
                <form method="POST" action="{{ route('logout') }}" x-data>
                    ...
                    <button class="bg-gradient-to-t from-[#72b2e4] to-[#92e1e2] text-white px-5 py-2 rounded-full hover:bg-[#87acec] font-[Kanit]">ออกจากระบบ</button></a>
                </form>

                <a href="/user/profile"><button class="bg-gradient-to-t from-[#72b2e4] to-[#92e1e2] text-white px-5 py-2 rounded-full hover:bg-[#87acec] font-[Kanit]">ตั้งต่าโปรไฟล์</button></a>
 ...
 <script>
        ...
        function onToggleMenu(e){
            ...
            navLinks.classList.toggle('top-[4.9%]')
        }
    </script>
